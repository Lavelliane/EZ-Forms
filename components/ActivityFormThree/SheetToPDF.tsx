						...
						<div className='w-[660px] h-fit bg-white relative justify-center'>
							...
							<div>
								...
								<div className='pl-5'>
									...
									<p>
										5. For concessionaires, attach the following: Mayor’s permit, Sanitation permit, contract/agreement
										with S.O.
									</p>
									<p>6. For Electrical Connection, go to the Accounting Office.</p>
									<br />
									<p className='font-semibold'>
										Note: Submit this form in duplicate at least two weeks before the activity. However, if it’s a major
										activity, secure permit at least one month before the activity.
									</p>
									<br />
								</div>
