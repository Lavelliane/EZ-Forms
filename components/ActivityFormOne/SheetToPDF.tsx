							...
							<div className='w-[660px] h-fit bg-white relative'>
								<div>
									...
									<div className='pl-5'>
										...
										<p>
											2. List of Participants with corresponding Parent’s Permits for activities held outside the
											campus.
										</p>
									...
									<p>
										...
										the activity. Activity permit must be claimed before the date of activity. Otherwise, this permit
										will no longer be given to the organization.
									</p>
								</div>
								<div className='border border-dark p-1 mt-1 text-[9px] font-semibold italic'>
									...
									<p>
										DEVOTIO: Activities that addresses prevailing social realities, activates one’s kindness,
										compassion, service, being philanthropic etc., allows one to volunteer one’s expertise, and gives
										back valued contributions to others or the community.
									</p>
									<p>
										ORGANIZATIONAL/ROUTINAL: Activities that are done to run the organization effectively. E.g.
										meetings, assemblies.
									</p>
								</div>
