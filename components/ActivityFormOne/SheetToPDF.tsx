				...
				<div ref={pdfRef} className='shadow-lg bg-white p-5'>
					<div className='w-[660px] h-fit bg-white relative'>
						...
						<div>
							...
							<p>
								<span className='font-semibold'>Note:</span> Submit this form in duplicate at least one week before the
								activity. Activity permit must be claimed before the date of activity. Otherwise, this permit will no
								longer be given to the organization.
							</p>
						</div>
