							...
							<div>
								...
								<div className='pl-5'>
									<p>
										...
										corresponding Parent’s Permits for activities held outside the campus and note of commitment from
										the faculty-adviser.
									</p>
									<br />
									<p className='font-semibold'>
										Activity permit must be claimed before the date of activity. Otherwise, this permit will no longer
